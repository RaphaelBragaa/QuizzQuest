function validaCampos() {
    ...
    if (titulo == '' || url == '' || nivel == '' || qtdePerguntas == '') {
        ...
        const objectScreen01 = {
            title: titulo,
            url,
            nivel,
            qtdePerguntas
        }
        console.log(objectScreen01);
        localStorage.setItem("objectScreen01", JSON.stringify(objectScreen01));
        // Redirecionar para a próxima página
        location.href = "../../pages/create-quizz/createNivel.html";
    }
}
